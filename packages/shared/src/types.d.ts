...
export type TxnKind = 'SIGNUP_BONUS' | 'TRANSFER' | 'REQUEST_SETTLE' | 'SPLIT' | 'HOLD_SETTLE' | 'HOLD_CANCEL' | 'REVERSAL' | 'REFUND' | 'ESCROW_PLACE' | 'ESCROW_CLAIM' | 'ESCROW_REFUND' | 'BILL_SHARE_SETTLE';
